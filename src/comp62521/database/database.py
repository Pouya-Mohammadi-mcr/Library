...
class Publication:
    ...
    def __init__(self, pub_type, title, link , year, authors, booktitle, journ, vol, pages, number, crossref, ee, isbn):
...
class Database:
    ...
    def add_publication(self, pub_type, title, link , year, authors, booktitle, journ, vol, pages, number, crossref, ee, isbn):
        ...
        self.publications.append(
            Publication(pub_type, title, link, year, idlist, booktitle, journ, vol, pages, number, crossref, ee, isbn))
    ...
    def get_all_publications(self):
        header = ('Publications', 'Authors', 'Year', 'Book title', 'Journal', 'Volume', 'Pages', 'Number', 'Cross reference', 'Url', 'ISBN')
        all_publications = []
        ...
        for p in self.publications:
            ...
            if link_valid:
                ...
                all_publications.append([p.title, p.link, authors_list, p.year, booktitle, jn, vol, pages, number, crossref, ee, isbn])
